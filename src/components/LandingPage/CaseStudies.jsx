...
import { Shield, Zap, ArrowLeft, FileText } from "lucide-react";
import PageHead from "../PageHead/PageHead";

const CaseStudies = () => {
  return (
    <>
      <PageHead pageTitle="Case Studies" />
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <p className="text-gray-300 text-lg max-w-md">
                Real-world case studies showcasing how DigitalAxis has helped businesses 
                protect their websites from attacks are coming soon. Check back later for success stories.
              </p>
