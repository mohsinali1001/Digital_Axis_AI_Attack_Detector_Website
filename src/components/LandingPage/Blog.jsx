...
import { Shield, Zap, ArrowLeft, Newspaper } from "lucide-react";
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <p className="text-gray-300 text-lg max-w-md">
                Our blog is under development. Soon you'll find articles about cybersecurity, 
                AI-powered threat detection, best practices, and industry insights.
              </p>
